...
class ControlObject(object):
    def __init__(self, veh):
        ...
        self._vehicle = veh  # 存储所控制的车辆对象
        self._steer = 0  # 转向
        self._throttle = False  # 油门
        self._brake = False  # 制动
        self._steer = None
        self._steer_cache = 0  # 转向缓存
        # A carla.VehicleControl object is needed to alter the vehicle's control state
        self._control = carla.VehicleControl()  # 实例化 carla.VehicleControl 对象，用于修改车辆的控制状态
    ...
    def process_control(self):
        ...
        if self._throttle:
            ...
            self._control.gear = 1  # gear: 齿轮、档
